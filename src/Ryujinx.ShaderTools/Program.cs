...
namespace Ryujinx.ShaderTools
{
    class Program
    {
        ...
        static void HandleArguments(Options options)
        {
            ...
            ShaderProgram program = options.VertexPassthrough
                ? translatorContext.GenerateVertexPassthroughForCompute()
                : translatorContext.Translate(options.VertexAsCompute);
