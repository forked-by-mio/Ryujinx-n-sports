...
{
    interface IContentStorage : IServiceObject
    {
        ...
        Result GetPath(out Path path, ContentId contentId);
        Result GetPlaceHolderPath(out Path path, PlaceHolderId placeHolderId);
        ...
        Result ReadContentIdFile(Span<byte> buffer, ContentId contentId, long offset);
        Result GetRightsIdFromPlaceHolderId(out RightsId rightsId, PlaceHolderId placeHolderId, ContentAttributes attr);
        Result GetRightsIdFromContentId(out RightsId rightsId, ContentId contentId, ContentAttributes attr);
        ...
        Result GetRightsIdFromPlaceHolderIdWithCache(out RightsId rightsId, PlaceHolderId placeHolderId, ContentId cacheContentId, ContentAttributes attr);
        Result RegisterPath(ContentId contentId, in Path path);
        Result ClearRegisteredPath();
        Result GetProgramId(out ProgramId programId, ContentId contentId, ContentAttributes attr);
    }
}