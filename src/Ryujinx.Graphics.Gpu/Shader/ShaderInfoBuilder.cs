...
namespace Ryujinx.Graphics.Gpu.Shader
{
    ...
    class ShaderInfoBuilder
    {
        ...
        {
            ShaderInfoBuilder builder = new ShaderInfoBuilder(context, tfEnabled: false, vertexAsCompute: false);
        ...
        {
            ShaderInfoBuilder builder = new ShaderInfoBuilder(context, tfEnabled: false, vertexAsCompute: true);
